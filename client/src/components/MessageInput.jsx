  ...
  return (
     <form className='flex relative' onSubmit={handleSendMessage}>
           <button type='button' onClick={()=> setShowEmojiPicker(!showEmojiPicker)}
            className='absolute left-3  transform translate-y-1/2 text-gray-400  hover:text-pink-500 focus:outline-none'
            >
                <Smile size={24} />
            </button>
           ...
           focus:outline-none focus:ring-2 focus:ring-pink-300'
            ...
            <button type='submit'
               className='bg-pink-500 text-white p-3 rounded-r-lg hover:text-pink-600 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-300'
               >
                <Send size={24} />
            </button>
